...
int main(void) {
	...
	tim_handle.Init.Prescaler = 21600;
	...
	tim_handle2.Init.Period = 50000;
	tim_handle2.Init.Prescaler = 21600;
	...
	HAL_GPIO_Init(GPIOH, &led3);

	__HAL_RCC_TIM12_CLK_ENABLE();
	tim_handle3.Instance = TIM12;
	tim_handle3.Init.Period = 50000;
	tim_handle3.Init.Prescaler = 21600;
	...
	while (1) {
		...
		//if ((0 < cnt && cnt< 15000)&&(0 < cnt2 && cnt2< 15000)&&(0 < cnt3 && cnt3< 15000) )
		if (0 < cnt && cnt< 15000)
		{
		...
		//else if ((15000 < cnt && cnt< 20000)&&(15000 < cnt2 && cnt2< 20000)&&(15000 < cnt3 && cnt3< 20000))
		else if (15000 <= cnt && cnt< 20000)
		{
			//HAL_GPIO_WritePin(GPIOI, GPIO_PIN_0, GPIO_PIN_SET);
			HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_SET);
			//HAL_GPIO_WritePin(GPIOH, GPIO_PIN_6, GPIO_PIN_RESET);
		}
		//else if ((20000 < cnt && cnt< 40000)&&(20000 < cnt2 && cnt2< 40000)&&(20000 < cnt3 && cnt3< 40000))
		else if (20000 <= cnt && cnt< 40000)
		{
			HAL_GPIO_WritePin(GPIOI, GPIO_PIN_0, GPIO_PIN_RESET);
			HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_RESET);
			HAL_GPIO_WritePin(GPIOH, GPIO_PIN_6, GPIO_PIN_SET);
		}
		//else if ((40000 < cnt && cnt< 49000)&&(40000 < cnt2 && cnt2< 49000)&&(40000 < cnt3 && cnt3< 90000))
		else if (40000 <= cnt && cnt< 49000)
		{
			//HAL_GPIO_WritePin(GPIOI, GPIO_PIN_0, GPIO_PIN_RESET);
			HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_SET);
			HAL_GPIO_WritePin(GPIOH, GPIO_PIN_6, GPIO_PIN_RESET);
